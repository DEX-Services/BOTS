...
type optionsMarketMaker struct {
	state          *State
	underlying     string // e.g. "BTC-BI2XUSD", passed as bot.Symbol
	quoteAsset     string
...
func optionsMMParams() []models.TemplateParam {
	return []models.TemplateParam{
		{Key: "symbol", Label: "Underlying", Type: "text", Required: true, Default: "BTC-BI2XUSD", Help: "The underlying spot pair, e.g. BTC-BI2XUSD"},
...
func newOptionsMarketMaker(bot *models.Bot) (Strategy, error) {
	...
	return &optionsMarketMaker{
		state: newStatePtr(), underlying: bot.Symbol, quoteAsset: "BI2XUSD",
