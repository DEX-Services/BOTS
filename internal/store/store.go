...
// ("CrudeOIL-BI2XUSD", "AAPL.us-BI2XUSD"). Upper-casing a caller's input before the
// lookup — as this path used to — turned those into "CRUDEOIL-BI2XUSD" /
// "AAPL.US-BI2XUSD", which match no row, so every desk on those four markets was
