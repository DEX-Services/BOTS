...
// real key's casing doesn't survive baseAsset's uppercasing ("CrudeOIL-BIUSDB"
// -> "CRUDEOIL", "AAPL.us-BIUSDB" -> "AAPL.US", neither of which is a key
// Price-Fetcher ever writes). Without that override the lookup falls back to
// the pair-derived base asset ("BTC-BIUSDB" -> "BTC").
