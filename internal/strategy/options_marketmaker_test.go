...
func optionsMMBot(config map[string]string) *models.Bot {
	...
	return &models.Bot{Symbol: "BTC-BI2XUSD", Market: models.Options, Investment: "50000", Config: merged}
}
...
func TestNewOptionsMarketMaker_ReadsInvestmentFromTopLevelField(t *testing.T) {
	bot := &models.Bot{
		Symbol: "BTC-BI2XUSD", Market: models.Options, Investment: "50000",
...
func TestOptionsMM_ApplyFillIfAny_SellCreditsPremium(t *testing.T) {
	...
	ref := OrderRef{OrderID: "o1", Side: "SELL", Price: "500", Qty: "1", Kind: "BTC-BI2XUSD-60000-20260101-CALL"}
...
func TestOptionsMM_ApplyFillIfAny_BuyDebitsPremium(t *testing.T) {
	m := &optionsMarketMaker{state: newStatePtr()}
	ref := OrderRef{OrderID: "o2", Side: "BUY", Price: "500", Qty: "1", Kind: "BTC-BI2XUSD-60000-20260101-CALL"}
...
func TestOptionsMM_ApplyFillIfAny_PartialFillOnlyAppliesDelta(t *testing.T) {
	m := &optionsMarketMaker{state: newStatePtr()}
	ref := OrderRef{OrderID: "o3", Side: "SELL", Price: "200", Qty: "1", Kind: "BTC-BI2XUSD-60000-20260101-PUT", AppliedFilled: "0.3"}
...
func TestOptionsMM_NetDelta_ZeroWithNoPositions(t *testing.T) {
	m := &optionsMarketMaker{state: newStatePtr()}
	chain := []engine.OptionChainEntry{{Symbol: "BTC-BI2XUSD-60000-20260101-CALL", Delta: 0.5}}
...
func TestOptionsMM_NetDelta_WeightsHeldPositionsByChainDelta(t *testing.T) {
	m := &optionsMarketMaker{state: newStatePtr()}
	callSymbol := "BTC-BI2XUSD-60000-20260101-CALL"
	putSymbol := "BTC-BI2XUSD-50000-20260101-PUT"
...
func TestOptionsMM_NetDelta_IgnoresPositionsNotInChain(t *testing.T) {
	m := &optionsMarketMaker{state: newStatePtr()}
	expiredSymbol := "BTC-BI2XUSD-40000-20250101-CALL"
